...
class HalfAlexNet(nn.Module):
    def __init__(self, obs_shape):
        ...
        self.conv_block_1 = nn.Sequential(
            nn.Conv2d(obs_shape[0], 48, 3, 1, 1, bias=False),  # 64 -> 64
            nn.BatchNorm2d(48),
...
class Agent(nn.Module):
    def __init__(self, obs_shape, action_shape, lr, feature_dim, hidden_dim, critic_target_tau, num_expl_steps,
        ...
        # models
        self.encoder = HalfAlexNet(obs_shape)
